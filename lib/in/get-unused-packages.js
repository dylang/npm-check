...
function checkUnused(currentState) {
    ...
    return new Promise(resolve => {
        ...
        const unusedDependencies =
          [].concat(depCheckResults.dependencies, depCheckResults.peerDependencies, depCheckResults.devDependencies);
        ...
        const missingFromPackageJson = _.omit(depCheckResults.missing || {},
                    Object.keys(cwdPackageJson.dependencies), Object.keys(cwdPackageJson.peerDependencies),
