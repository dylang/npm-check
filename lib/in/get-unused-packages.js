...
function getIgnoreDirs(currentState) {
    let defaultIgnoreDirs = [
        'sandbox',
        'dist',
        'generated',
        '.generated',
    ...
    let cliIgnoreDirs = currentState.get('ignoreDirs')
    cliIgnoreDirs = cliIgnoreDirs?cliIgnoreDirs.split(','):[];
    let ignoreDirs = [...defaultIgnoreDirs];
    cliIgnoreDirs.forEach(dir => {
...
function checkUnused(currentState) {
    ...
    return new Promise(resolve => {
        ...
        const depCheckOptions = {
            ignoreDirs: getIgnoreDirs(currentState),
            ignoreMatches: [
                'gulp-*',
                'grunt-*',
                'karma-*',
