...
function createPackageSummary(moduleName, currentState) {
    ...
    return getLatestFromRegistry(moduleName).then(fromRegistry => {
        ...
        const lastModifiedDifferenceInYears = differenceInCalendarYears(
            new Date(),
            new Date(fromRegistry.lastModified),
        );
        ...
        return {
            ...
            unused: unused,
            lastModifiedDifferenceInYears: lastModifiedDifferenceInYears,
        };
    });
}
