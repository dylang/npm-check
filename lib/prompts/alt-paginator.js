...
/*eslint-disable */
/**
 * This is straight copied from inquirer which has a bug that
 * breaks checkbox selections that are more than seven items.
 */
...
Paginator.prototype.paginate = function (output, active) {
  var pageSize = process.stdout.rows - 2; // [dylang] Changed hardcoded 7 to process.stdout.rows - 2
