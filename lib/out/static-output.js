...
function render(pkg, currentState) {
    ...
    const status = _([
        ...
        pkg.regError
            ...
            : '',
        pkg.lastModifiedDifferenceInYears >= 2 &&
            chalk.bgRed.white.bold(
                emoji(' :face_with_head_bandage: ') +
                    ' The last release for this dependency was published more than 2 years ago! You might want to consider installing a similar, more up-to-date dependency instead!',
            ),
    ])
        .flatten()
        .compact()
