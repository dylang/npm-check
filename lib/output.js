...
function render(moduleName, data) {
    ...
    var status = _([
            ...
            data.bump && data.easy_upgrade ? [
                chalk.bgGreen.white.bold(' ' + emoji.poop + '  UPDATE!  ') + ' Your local install is out of date. ',
            ...
            data.unused ? [chalk.black.bold.bgWhite(' ' + emoji.confused + '  NOTUSED? ') + ' Possibly never referenced in the code.',
